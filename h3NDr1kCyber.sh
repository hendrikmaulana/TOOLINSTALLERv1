...
#GW AJA NGERECODE:V
#KE TEMEN GW YANG BURIQ
#TUAN GENDUT:V?EHH TUANBADUT
#SUSAH PAYAH GW RECODE
#EHHH MALAH DI RECODE BALIK
$EAAA DASAR GA PUNYA MALU:V
...
sleep 1
echo ""
echo -b $green"[#]> h3NDr1k Cyb3r On Your System" |lolcat
...
echo -e "╭─h3NDr1k Cyb3r[PILIH NOMORNYA]" | lolcat
read -p "╰─#" pil;
...
99) echo "AUTHOR:h3NDr1k Cyb3r" | lolcat
echo "h3NDr1k Cyb3r ON YOUR SYSTEM" | lolcat
echo "INDONESIAN TERMUX ASSOCUATION" | lolcat
